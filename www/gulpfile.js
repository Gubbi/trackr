...
gulp.task('copy', function () {
  ...
  var auth_vulcanized = gulp.src(['app/elements/auth/auth.html'])
    .pipe($.rename('auth.vulcanized.html'))
    .pipe(gulp.dest('dist/elements/auth'));

  var sys_vulcanized = gulp.src(['app/elements/sys/sys.html'])
...
gulp.task('html', function () {
  ...
  return gulp.src(['app/**/*.html', '!app/{elements,test,bower_components}/**/*.html'])
    ...
    .pipe($.if('*.html', $.replace('elements/sys/sys.html', 'elements/sys/sys.vulcanized.html')))
    .pipe(assets)
