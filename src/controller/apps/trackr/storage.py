...
from service.gcs import get_gcs_file
...
class StorageController(SignedInController):
...
#[END get_default_bucket]
    ...
    bucket = '/' + bucket_name
    filename = bucket + '/dummy_icici.csv'
    ...
    try:
      ...
      reader = csv.DictReader(get_gcs_file('dummy_icici.csv').splitlines(1))
      for row in reader:
        for key, value in row.iteritems():
          _key = key.decode('utf8')
